    ...
    methods: {
        ...
        async getCommunes() {
            ...
            for (const region_id of region_ids) {
                try {
                const response = await axios.get(
                    "https://binfrix.com/api/commune/" + region_id,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
                                accept: "application/json",
        ...
        async getSelectedRegionsCommunes() {
            ...
            try {
                const response = await axios.get(
                "https://binfrix.com/api/category_commune/" + this.$route.params.id,
                {
                    headers: {
                    accept: "application/json",
                    Authorization: `Bearer ${token}`,
        ...
        async submit() {
            ...
            try {
                const response = await axios.post(
                    "https://binfrix.com/api/category/" + this.$route.params.id,
                    formData,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
        ...
        async getData() {
            ...
            try {
                const response = await axios.get(
                    "https://binfrix.com/api/category_region/" + this.$route.params.id,
                    {
                        headers: {
                            accept: "application/json",
                            Authorization: `Bearer ${token}`,
