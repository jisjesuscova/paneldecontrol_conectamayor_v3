...
export default {
    ...
    methods: {
            ...
            if (confirm("¿Estás seguro de que deseas copiar la categoría?")) {
                ...
                try {
                    const response = await axios.get(
                        "http://example.test/api/category/copy/" + id,
                        {
                            headers: {
        ...
        async moveDown(id) {
            ...
            try {
                const response = await axios.get(
                    "http://example.test/api/category/move_down/" + this.section_input + "/" + id,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            accept: "application/json",
        ...
        async moveUp(id) {
            ...
            try {
                const response = await axios.get(
                    "http://example.test/api/category/move_up/" + this.section_input + "/" + id,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            accept: "application/json",
        ...
        async getData() {
            ...
            try {
                const response = await axios.get(
                    "http://example.test/api/category/",
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            accept: "application/json",
