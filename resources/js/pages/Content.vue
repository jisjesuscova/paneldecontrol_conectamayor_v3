...
export default {
    ...
    methods: {
            ...
            if (confirm("¿Estás seguro de que deseas copiar el contenido?")) {
                ...
                try {
                    const response = await axios.get(
                        "http://binfrix.com/api/content/copy/" + id,
                        {
                            headers: {
        ...
        async moveDown(id) {
            ...
            try {
                const response = await axios.get(
                    "http://binfrix.com/api/content/move_down/" + this.section_input + "/" + this.category_input + "/" + id,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            accept: "application/json",
                ...
                try {
                    const response = await axios.get(
                        "http://binfrix.com/api/content/search/" + this.section_input + "/" + this.category_input,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
                                accept: "application/json",
        ...
        async moveUp(id) {
            ...
            try {
                const response = await axios.get(
                    "http://binfrix.com/api/content/move_up/" + this.section_input + "/" + this.category_input + "/" + id,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            accept: "application/json",
        ...
        async getCategories() {
            ...
            try {
                const response = await axios.get(
                    "http://binfrix.com/api/category/all/" + this.section_input,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            accept: "application/json",
